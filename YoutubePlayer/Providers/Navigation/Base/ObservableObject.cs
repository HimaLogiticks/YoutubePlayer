...
{
    /// <summary>
    /// Base object for the ViewModel, Viewmodels we will create for 2 different purpose. 
    /// One for a page level and other for data. Page Level we should use PageViewModelBase and Data we use DataViewModelBase.
    /// </summary>
